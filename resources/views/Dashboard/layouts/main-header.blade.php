...
<div class="main-header sticky side-header nav nav-item">
	<div class="container-fluid">
		...
		<div class="main-header-right">
            <div class="palestine vertical">
                <img  class="mx-4" width="70 px" height="45 px" src="{{URL::asset('Dashboard/img/Palestine.gif')}}" alt="فلسطين حرة">
			...
			<div class="nav nav-item  navbar-nav-right ml-auto">
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					...
					<div class="dropdown-menu">
                        ...
                        @else
                              <form id="logout-form" action="{{ route('logout.lab') }}" method="POST">
                        @endif
                        <a
							class="dropdown-item" href="{{ route('logout.user') }}" onclick="event.preventDefault();
