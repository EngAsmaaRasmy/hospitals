...
use App\Http\Controllers\Auth\LabController;
...
//############# route Lab  ###########
Route::post('/login/lab', [LabController::class, 'store'])->middleware('guest')->name('login.lab');

//#######lab logout#########
Route::post('/logout/lab', [LabController::class, 'destroy'])->middleware('auth:lab')->name('logout.lab');
